...
<head>
	...
	.diary_tb {
	 width: 100%; word-break: break-all; position: relative; text-align: center; word-wrap: break-word
	}
	.diary_main {
	 table-layout: fixed;font-size: 12px; color: #005782; word-break: break-all; line-height: 24px; font-family: "宋体"; line-break: strict; height: 2px; text-align: left
	}
	
	.main_cal{ border::solid 1px #000}
	
	.maina tbody tr td input{width:40px}
	.mainb tbody tr td input{width:40px}
	.mainc{ }
	</STYLE>
...
<TABLE id=AutoNumber2 style="BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=760 border=0></TABLE>
...
<DIV align=center>
<CENTER>
<TABLE id=AutoNumber2 style="BORDER-COLLAPSE: collapse" cellSpacing=0 cellPadding=0 width=760 border=0>
  <TBODY>
  <TR>
      ...
      border=0>
        <TBODY>
          <TD align=middle width="100%" height=30>
            ...
            <DIV align=center>
            <FORM name=calc>
            <TABLE height=250 width=500 border=0 class="main_cal">
              <TBODY>
              <TR>
                <TD height=50>
                  <TABLE width=500>
                  ...
                  name=display class="mainc" value=0 
                        size=67 readOnly>
                    ...
                    <TR>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            <TD><INPUT style="COLOR: red" onclick=clearmemory() type=button value=" 清存 "> 
                          </TD></TR></TBODY></TABLE></TD>
                      <TD width=30></TD>
                      <TD>
                        <TABLE class="mainb">
