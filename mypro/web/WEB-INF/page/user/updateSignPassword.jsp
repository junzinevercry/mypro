...
<script type="text/javascript">
	...
	function checkPassword(){
		...
		$.ajax({
			type:'post',
			url:'${ctx}/user/doUpdateSignPassword.action',
			dataType:"json",
...
<body bgcolor="#e1f4ff">
	<div class="basecontent">
		<div class="boss" >当前位置：修改签名密码</div>
		<div class="tablebox">
			<form action="" method="post" id="saveform" name="saveform">
			    <table width="100%" border="0" cellspacing="0" cellpadding="0">
					<thead>
						<tr>
							<td colspan="2"  class="font1">修改签名密码</td>
						</tr>
					</thead>
					<tr>
			     	...
			     	<tr>
				        <td colspan="2" style="background: #bee3f9;" align="center" valign="middle">	
				            ...
				            <img src="${ctx }/resource/images/button/oa_icon_button_yes.png" onclick="checkPassword()">			        
